...
/** @type {Question[]} */
export const QUESTION_BANK_SMP_G8 = [
  {
    id: 'smpg8-mcq-1',
    type: 'mcq',
    prompt:
...
const EXAM_SMP_G8_QUESTION_IDS = [
  'smpg8-mcq-1',
  'smpg8-mcq-2',
  'smpg8-mcq-3',
  'smpg8-mcq-4',
...
/** @type {Exam} */
export const EXAM_SMP_G8 = {
  id: 'kuis-ct-smp-grade-8',
  ...
  questions: EXAM_SMP_G8_QUESTION_IDS.map((id) =>
    QUESTION_BANK_SMP_G8.find((question) => question.id === id),
  ),
}
