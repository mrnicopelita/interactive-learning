...
import {
  ...
  SENSOR_NAMES,
  METRICS,
} from './artemis2Data.js'

const STORAGE_KEY = 'artemis2-telemetry-v1'
const CHANNEL_NAME = 'artemis2-telemetry'
...
const INTRO_LINES = [
  ...
  {
    en: 'Three years of Artemis II telemetry — Crewed Lunar Flyby, Deep Space Gateway, and Lunar Orbit Rendezvous — arrived scrambled into one massive unsorted data stream.',
    id: 'Data telemetri misi Artemis II — Terbang Lintas Berawak, Gerbang Luar Angkasa Dalam, dan Rendezvous Orbit Bulan — tiba teracak dalam satu aliran data raksasa yang belum diurutkan.',
  },
  {
        ...
        <div className="animate-pop-in flex w-full max-w-2xl flex-col items-center gap-5 rounded-3xl bg-white/95 p-6 text-center shadow-lg sm:p-10">
          ...
          <div>
            <h1 className="text-[clamp(1.75rem,6vw,3rem)] font-extrabold leading-none text-slate-700">
              Operation <span className="text-sky-600">Artemis II</span>
            </h1>
...
export default function Artemis2Game({ onExit }) {
